<template>
  <el-footer>
    <div class="footer-content">
      <component v-for="(line, index) in footerLines" is="h3" :key="index">
        {{ line }}
      </component>
    </div>
    <div>
      <p>
        1.2025年春季系列中使用试生产的80支双股长绒棉牛津纺面料（经纬向密度均为120根/英寸）进行了此项评估。该面料均配置天然母贝纽扣与强化袖口衬里。抗皱性能依据在模拟8小时办公场景下（包括伏案打字、手臂屈伸及通勤乘坐等系列动作）的折痕恢复率进行评估。实际抗皱表现依具体穿着习惯和坐姿的不同可能有所差异。
      </p>
      <p>
